...
class _HistoricoWidgetState extends State<HistoricoWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.outHistorico = await EntregasTable().queryRows(
        queryFn: (q) => q
            .eqOrNull(
              'id_cli',
              currentUserUid,
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<EntregasRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<EntregasRow> historicoEntregasRowList = snapshot.data!;
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Builder(
                            builder: (context) {
                              final varListHistorico =
                                  _model.outHistorico?.toList() ?? [];

                              return ListView.separated(
                                padding: EdgeInsets.zero,
                                shrinkWrap: true,
                                scrollDirection: Axis.vertical,
                                itemCount: varListHistorico.length,
                                separatorBuilder: (_, __) =>
                                    SizedBox(height: 2.0),
                                itemBuilder: (context, varListHistoricoIndex) {
                                  final varListHistoricoItem =
                                      varListHistorico[varListHistoricoIndex];
                                  return Padding(
