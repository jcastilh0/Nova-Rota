...
class EsqueciMinhaSenhaWidget extends StatefulWidget {
  ...
  static String routeName = 'esqueci_minha_senha';
  static String routePath = '/esqueciMinhaSenha';
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 16.0),
                              child: Text(
                                'Informe o email para recuperar seu acesso.',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Inter',
