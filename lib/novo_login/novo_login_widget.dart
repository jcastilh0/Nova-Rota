...
import 'novo_login_model.dart';
export 'novo_login_model.dart';

class NovoLoginWidget extends StatefulWidget {
  const NovoLoginWidget({super.key});

  static String routeName = 'NovoLogin';
  static String routePath = '/novoLogin';

  @override
  State<NovoLoginWidget> createState() => _NovoLoginWidgetState();
}

class _NovoLoginWidgetState extends State<NovoLoginWidget>
    with TickerProviderStateMixin {
  late NovoLoginModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NovoLoginModel());
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Image.asset(
                      'assets/images/NovaRota1-removebg-preview.png',
                      width: 250.0,
                      fit: BoxFit.fitWidth,
                    ),
                  ],
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      if (_model.saidaUserLogin?.firstOrNull
                                              ?.tipo ==
                                          'Motorista') {
                                        context.pushNamedAuth(
                                          PaginaMotoristaWidget.routeName,
                                          context.mounted,
                                          queryParameters: {
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamed(
                                          EsqueciMinhaSenhaWidget.routeName);
                                    },
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      if (_model.tipoUserValue == 'Motorista') {
                                        context.pushNamedAuth(
                                          PaginaMotoristaWidget.routeName,
                                          context.mounted,
                                          queryParameters: {
